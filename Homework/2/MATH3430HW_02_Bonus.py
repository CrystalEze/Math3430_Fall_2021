...
def sca_vec_mult(Vector, Scalar):
    result = []
...
# sca_vec_mult(test_vector_05,test_scalar) should output [10,15,40]
print('Test Output for sca_vec_mult: ' + str(sca_vec_mult(test_vector_05,test_scalar)))
print('Should have been [10,15,40]')

test_vector_01 = [1, 2, 4]
test_scalar = 4

# sca_vec_mult(test_vector_01,test_scalar) should output [4,8,16]
print('Test Output for sca_vec_mult: ' + str(sca_vec_mult(test_vector_01,test_scalar)))
...
#Initialize a result matrix of 0's which is the same size as the matrix list

#Initialize an empty list to append 0's to'

#For each matrix list write as for loop of sca_vec_mult(scalar, vector_a)

#Set result equal to the next for loop

#For each matrix list, set the result equal to the sum of all the lists
...
print('Test Output for mat_vec_mult: ' + str(mat_vec_mult(test_matrix_07,test_vector_06)))
...
print('Test Output for mat_vec_mult: ' + str(mat_vec_mult(test_matrix_08,test_vector_07)))
